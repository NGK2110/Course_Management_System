...
<body>
<h1 style="color: blue;"><u><b>DELETE Employee DETAILS</b></u></h1>
...
if($id)
{
    ...
    echo "<a href=\"delf.php?ids=$id\"><p align='center'><input type='submit' name='btn' value='CONFIRM'/></p></a>";
    if($result->num_rows == 0){
        echo "<script> alert('ID not found !');window.location.href='fdel.php';</script>";
    }
}
}
mysqli_close($dbh);
