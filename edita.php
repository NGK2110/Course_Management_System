...
if(isset($_REQUEST["btn"])){
    ...
    $result=mysqli_query($dbh,"UPDATE admin SET Name='$nname',Fname='$nfname',Post='$nqual',Sex='$nsex',DOB='$ndob',Contact='$ncontact',Password='$npassword' WHERE ID=$id");
    if (!$result){     
        echo '<script> alert("Failed to Update!"); </script>';
    }
    else{
        echo '<script> alert("Successfully Updated!"); window.location.href="mpa.php"</script>';
    }
}
mysqli_close($dbh);
?>