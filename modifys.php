...
<body>
<h1 style="color: blue;"><u><b>MODIFY STUDENT DETAILS</b></u></h1>
...
if($id)
{
    ...
    echo "</table><br>";
    echo "<a href=\"edits.php?ids=$id & names=$name & fnames=$fname & quals=$qual&dobs=$dob&sexs=$sex&contacts=$contact&passwords=$password\">
    <p align='center'><input type='submit' name='btn' value='CONFIRM'/></p></a>";
    if($result->num_rows == 0){
        echo "<script> alert('Admission number not found !');window.location.href='modifys.php';</script>";
    }
}
}
mysqli_close($dbh);
