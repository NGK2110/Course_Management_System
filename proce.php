...
$id=$row['Sno'];
$result=mysqli_query($dbh,"SELECT * FROM student WHERE Proc=$id");
if(!$result)
die("Database access failed: ".mysqli_error());
echo "<body style='background-color:pink'>";
echo "<p align='center'><font color=blue font face='arial' size='6pt'><b><u>PROCTEE DETAILS</b></u></font></p><br><br>";
