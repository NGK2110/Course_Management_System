...
<body>
<h1 style="color: blue;"><u><b>MODIFY FACULTY DETAILS</b></u></h1>
<form method="post" action="">
<label><b>ID</b></label>
<input type="number" name="id"/><br><br>
<input type="submit" value="Modify" name="btn"/><br>
</form>
<br/> <br/> 
<a href="adminf.php">Back</a>&nbsp<span class="tab"></span>&nbsp<a href="admin.php">Home</a>
<br/> <br/> 
</body>
</html>
...
if($id)
{
    ...
    echo "<a href=\"editf.php?ids=$id & names=$name & fnames=$fname & quals=$qual&dobs=$dob&sexs=$sex&contacts=$contact&passwords=$password\">
    <p align='center'><input type='submit' name='btn' value='CONFIRM'/></p></a>";
    if($result->num_rows == 0){
        echo "<script> alert('Admission number not found !');window.location.href='modifyf.php';</script>";
    }
}
}
mysqli_close($dbh);
