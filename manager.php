...
<div class="container">
  <div class="login">
    <h1>Manager PAGE</h1>
      <center><p><a href="addm.html"><input type="submit" name="submit" value="ADD"></a></p>
      <p><a href="updatem.html"><input type="submit" name="submit" value="UPDATE"></a></p>
      <p><a href="deletem.html"><input type="submit" name="submit" value="DELETE"></a></p>
      <p><a href="displaym.html"><input type="submit" name="submit" value="DISPLAY"></a></p>
