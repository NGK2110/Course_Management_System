...
<div class="container">
  <div class="login">
    <h1>EMPLOYEE PAGE</h1>
      <center><p><a href="adde.html"><input type="submit" name="submit" value="ADD"></a></p>
      <p><a href="updatee.html"><input type="submit" name="submit" value="UPDATE"></a></p>
      <p><a href="deletee.html"><input type="submit" name="submit" value="DELETE"></a></p>
      <p><a href="displaye.html"><input type="submit" name="submit" value="DISPLAY"></a></p>
