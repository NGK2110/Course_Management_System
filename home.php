...
<div class="container">
  <div class="login">
    <h1>DASHBOARD</h1>
      <center><p><a href="employee.php"><input type="submit" name="submit" value="EMPLOYEE"></a></p>
      <p><a href="manager.html"><input type="submit" name="submit" value="MANAGER"></a></p>
      <p><a href="company.html"><input type="submit" name="submit" value="COMPANY"></a></p>
      <p><a href="display.html"><input type="submit" name="submit" value="DISPLAY"></a></p></center>
  </div>
</div>
<script>
